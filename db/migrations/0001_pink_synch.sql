...
ALTER TABLE "nuclei_db"."findings" ADD COLUMN "current_status" text DEFAULT 'detected';--> statement-breakpoint
ALTER TABLE "nuclei_db"."scans" ADD COLUMN "content" text;